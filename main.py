...
ESP32ID = "001"											# Preguntar a Wilson

WIFI_SSID     = 'Milo'                               # Nombre Wifi
WIFI_PASSWORD = 'Camilo2306'                            # Contrasena Wifi

URLGET= 'http://192.168.0.104:8090/validate'              # URL Para Obtener Datos Del Servidor  
URLPOST= 'http://192.168.0.104:8090/sensorsData'          # URL Para Enviar Datos Al Servidor

# Conexión a Wifi  					 # Preguntar a Wilson
...
# Recibir Datos # 					Preguntar a Wilson
...
# /////// Código principal / Main Code /////////			  # Preguntar a Wilson
...
def main():
    ...
    if(access):
        while True:
            ...
            if (dth1.temperature() >= 35 or dth1.temperature() <= 20 or humiditySensorValue <= 500 or dth1.humidity() > 60):
                ledPin.value(1)
